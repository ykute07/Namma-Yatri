...
import com.android.deliveryapp.databinding.ActivityReviewRestaurantBinding
...
class ReviewRestaurantActivity : AppCompatActivity() {
    private lateinit var binding: ActivityReviewRestaurantBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityReviewRestaurantBinding.inflate(layoutInflater)
        ...
        binding.button.setOnClickListener {
            if (binding.loginEmail?.text.isNullOrEmpty() && binding.reviewMessage.text.isNullOrEmpty()) {
                ...
                firestore.collection(Keys.reviewsRider)
                ...
                startActivity(Intent(this@ReviewRestaurantActivity, ClientHomeActivity::class.java))
                finish()
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.logout -> {
                ...
                startActivity(Intent(this@ReviewRestaurantActivity, LoginActivity::class.java))
                finish()
            }
        }
